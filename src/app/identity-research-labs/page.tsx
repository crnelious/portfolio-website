      ...
      <main className="max-w-7xl mx-auto px-8 sm:px-16 py-16">
        ...
        <section className="mb-20 grid gap-12 lg:grid-cols-[2fr,1fr]">
          <div>
            ...
            <p className="mt-6 text-lg leading-relaxed text-gray-700">
              Identity Research Labs explores how people manage, protect, and express their
              identities across emerging digital ecosystems. Use this template to articulate
              the full UX case study&mdash;from framing the problem through validated outcomes.
              Swap the placeholder copy with the specifics of your project narrative.
            </p>
            <ul className="mt-8 space-y-4 text-gray-700">
              <li className="flex gap-3">
                <span className="mt-2 h-2.5 w-2.5 rounded-full bg-gray-900" />
                <span>
                  Start with the context, challenge, and opportunity that set the stage for the
                  work.
                </span>
              </li>
              <li className="flex gap-3">
                <span className="mt-2 h-2.5 w-2.5 rounded-full bg-gray-900" />
                <span>
                  Show your process end-to-end: discovery, synthesis, design, validation, and launch.
                </span>
              </li>
              <li className="flex gap-3">
                <span className="mt-2 h-2.5 w-2.5 rounded-full bg-gray-900" />
                <span>
                  Highlight measurable outcomes, learnings, and how you evolved the solution after
                  release.
                </span>
              </li>
            </ul>
          ...
          <aside className="space-y-6">
            <div className="rounded-3xl border border-gray-200 bg-gray-50 p-6">
              <p className="text-sm uppercase tracking-[0.3em] text-gray-500">Role</p>
              <p className="mt-3 text-lg font-medium text-black">
                Product Designer &amp; Research Lead
              </p>
              <p className="mt-2 text-sm text-gray-600">
                Add the hats you wore: research strategy, interaction design, facilitation, etc.
              </p>
            </div>
            <div className="rounded-3xl border border-gray-200 bg-gray-50 p-6">
              <p className="text-sm uppercase tracking-[0.3em] text-gray-500">Team</p>
            ...
            <div className="rounded-3xl border border-gray-200 bg-gray-50 p-6">
              <p className="text-sm uppercase tracking-[0.3em] text-gray-500">Timeline</p>
              <p className="mt-3 text-lg font-medium text-black">10 weeks</p>
              <p className="mt-2 text-sm text-gray-600">
                Break down the phases (discovery, synthesis, build) to show how you paced the work.
              </p>
            </div>
          </aside>
        </section>
        ...
        <section className="mb-20 grid gap-10 md:grid-cols-2">
          <div className="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
            <p className="text-sm uppercase tracking-[0.3em] text-gray-500">Challenge</p>
            <h3 className="mt-4 text-2xl font-semibold text-black">
              Fragmented identity tooling created friction and trust issues
            </h3>
            <p className="mt-4 text-gray-700">
              Summarize the business goal and user pain. What was happening in the ecosystem?
              Why was the status quo no longer acceptable? Anchor your narrative in evidence.
            </p>
          </div>
          <div className="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
            <p className="text-sm uppercase tracking-[0.3em] text-gray-500">Opportunity</p>
            <h3 className="mt-4 text-2xl font-semibold text-black">
              Offer guidance, transparency, and control for identity journeys
            </h3>
            <p className="mt-4 text-gray-700">
              Define what success looked like for the business and for people using the product.
              Clarify constraints, edge cases, and strategic bets made along the way.
            </p>
          </div>
        </section>
        ...
        <section className="mb-20">
          <div className="rounded-3xl bg-gray-50 p-10">
            ...
            <div className="mt-8 grid gap-10 lg:grid-cols-3">
              <div>
                <h4 className="text-xl font-semibold text-black">User Outcomes</h4>
              ...
              <div>
                <h4 className="text-xl font-semibold text-black">Business Outcomes</h4>
                <ul className="mt-4 space-y-3 text-gray-700">
              ...
              <div>
                <h4 className="text-xl font-semibold text-black">Signals of Success</h4>
                <ul className="mt-4 space-y-3 text-gray-700">
        ...
        <section className="mb-20 grid gap-8 lg:grid-cols-2">
          <div className="rounded-3xl border border-gray-200 bg-white p-8">
            <p className="text-sm uppercase tracking-[0.3em] text-gray-500">My Responsibilities</p>
            <ul className="mt-6 space-y-4 text-gray-700">
              <li>Led discovery planning and stakeholder interviews</li>
              <li>Defined research protocol, synthesized insights, and aligned teams</li>
              <li>Shaped IA, interaction patterns, and accessibility requirements</li>
              <li>Partnered with engineers to scope V1 vs. north-star moments</li>
            </ul>
          </div>
          <div className="rounded-3xl border border-gray-200 bg-white p-8">
            <p className="text-sm uppercase tracking-[0.3em] text-gray-500">Partners</p>
            <div className="mt-6 space-y-6 text-gray-700">
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-gray-600">
                  2 full-stack engineers for feasibility checks and prototype builds.
                </p>
              </div>
              <div>
                <p className="text-sm font-semibold text-black">Legal &amp; Compliance</p>
                <p className="mt-2 text-sm text-gray-600">
        ...
        {/* Research Approach */}
        <section className="mb-20">
          <p className="text-sm uppercase tracking-[0.3em] text-gray-500">Research Approach</p>
          <div className="mt-8 grid gap-8 lg:grid-cols-3">
            <div className="rounded-3xl border border-gray-200 bg-gray-50 p-8">
              <h4 className="text-lg font-semibold text-black">Discovery</h4>
              <p className="mt-3 text-sm text-gray-600">
                Outline foundational interviews, competitive analysis, and desk research you ran to
                benchmark current confidence and gaps.
              </p>
            </div>
            <div className="rounded-3xl border border-gray-200 bg-gray-50 p-8">
              <h4 className="text-lg font-semibold text-black">Synthesis</h4>
              <p className="mt-3 text-sm text-gray-600">
                Capture affinity mapping, frameworks, or opportunity maps that unlocked direction.
              </p>
            </div>
            <div className="rounded-3xl border border-gray-200 bg-gray-50 p-8">
              <h4 className="text-lg font-semibold text-black">Validation</h4>
              <p className="mt-3 text-sm text-gray-600">
                Detail evaluative research rounds&mdash;usability testing, surveys, or analytics
                readouts used to shape the final solution.
              </p>
            </div>
          </div>
        ...
        <section className="mb-20">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <p className="text-sm uppercase tracking-[0.3em] text-gray-500">Key Insights</p>
              <h3 className="mt-2 text-3xl font-semibold text-black">
                What we learned about people managing their identities
              </h3>
            </div>
            <p className="max-w-xl text-sm text-gray-600">
              Translate raw research into crisp insight statements and tie each one back to the
              product moves it inspired. Include quotes or stats where available.
            </p>
          </div>
          <div className="mt-10 grid gap-6 lg:grid-cols-3">
            {[
              ...
              >
                ...
                <div className="mt-6 rounded-2xl border border-dashed border-gray-300 bg-gray-50 p-4 text-xs uppercase tracking-[0.2em] text-gray-400">
        ...
        {/* Personas */}
        <section className="mb-20">
          <p className="text-sm uppercase tracking-[0.3em] text-gray-500">Personas</p>
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            {["Verification Novice", "Cross-Border Professional"].map((persona) => (
              <div key={persona} className="rounded-3xl border border-gray-200 bg-white p-8">
                <div className="flex items-center gap-4">
                  <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gray-100 text-sm uppercase text-gray-500">
                    Img
                  </div>
                  <div>
                    <h4 className="text-xl font-semibold text-black">{persona}</h4>
                    <p className="text-sm text-gray-600">
                      Summarize their goal, behaviors, and identity management mindset.
                    </p>
                  </div>
                </div>
        ...
        <section className="mb-20">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <p className="text-sm uppercase tracking-[0.3em] text-gray-500">Journey Mapping</p>
              <h3 className="mt-2 text-3xl font-semibold text-black">
                Visualizing the end-to-end identity journey
              </h3>
            </div>
            <p className="max-w-xl text-sm text-gray-600">
              Document the moments that matter: triggers, actions, questions, emotions, and
              backstage processes. Show how insights fed into opportunity areas.
            </p>
          </div>
        ...
        <section className="mb-20 grid gap-12 lg:grid-cols-[1.2fr,1fr]">
          <div>
            <p className="text-sm uppercase tracking-[0.3em] text-gray-500">Information Architecture</p>
            <h3 className="mt-4 text-3xl font-semibold text-black">Structuring the experience</h3>
            <p className="mt-4 text-gray-700">
              Explain how you translated insights into flows, states, and content strategy.
              Annotate decisions: Why did you prioritize certain pathways? How did regulations
              shape the architecture?
            </p>
            <ul className="mt-6 space-y-3 text-gray-700">
              <li>Map the happy path along with contingencies and edge cases.</li>
              <li>Show hierarchy decisions (dashboards, step-by-step, modular cards).</li>
              <li>Highlight accessibility or localization considerations made early.</li>
            </ul>
          </div>
        ...
        {/* Design Exploration */}
        <section className="mb-20">
          <p className="text-sm uppercase tracking-[0.3em] text-gray-500">Design Exploration</p>
        ...
        <section className="mb-20 rounded-3xl border border-gray-200 bg-white p-10 shadow-sm">
          <p className="text-sm uppercase tracking-[0.3em] text-gray-500">Usability Testing</p>
          <div className="mt-8 grid gap-8 md:grid-cols-2">
            <div>
              <h4 className="text-xl font-semibold text-black">What we tested</h4>
              <ul className="mt-4 space-y-3 text-gray-700">
            ...
            <div>
              <h4 className="text-xl font-semibold text-black">What we learned</h4>
              <ul className="mt-4 space-y-3 text-gray-700">
                <li>Clarified threshold for when assistance is required</li>
                <li>Introduced progressive disclosure for sensitive data requests</li>
        ...
        {/* Final Solution */}
        <section className="mb-20">
          <p className="text-sm uppercase tracking-[0.3em] text-gray-500">Final Solution</p>
          <div className="mt-8 grid gap-8 lg:grid-cols-[1.2fr,1fr]">
            ...
            <div className="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
              <h4 className="text-xl font-semibold text-black">Measured Impact</h4>
              <ul className="mt-4 space-y-3 text-gray-700">
              ...
              <p className="mt-6 text-sm text-gray-600">
                Replace with concrete metrics, anecdotes, or partner testimonials. Tie impact back
                to the objectives defined earlier.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-20 grid gap-12 lg:grid-cols-2">
          <div className="rounded-3xl border border-gray-200 bg-white p-10">
            <p className="text-sm uppercase tracking-[0.3em] text-gray-500">What I Learned</p>
            <ul className="mt-6 space-y-4 text-gray-700">
              <li>Share a moment where research reframed the direction.</li>
              <li>Document collaboration wins or trade-offs you negotiated.</li>
              <li>Reflect on how this project influences your design practice.</li>
            </ul>
          </div>
          <div className="rounded-3xl border border-gray-200 bg-white p-10">
            <p className="text-sm uppercase tracking-[0.3em] text-gray-500">What&apos;s Next</p>
            <ul className="mt-6 space-y-4 text-gray-700">
        ...
        <section className="rounded-3xl bg-black px-10 py-12 text-white">
          <h3 className="text-3xl font-semibold">Let&apos;s build identity experiences people trust.</h3>
          <p className="mt-4 max-w-3xl text-gray-200">
            Invite readers to reach out for a walkthrough, deeper insights, or collaboration. Link
            out to supporting assets like research plans, prototypes, or press coverage.
          </p>
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <Link href="#" className="nav-pill border border-white text-white hover:bg-white/10">
              View Prototype
            </Link>
          </div>
        </section>
